...
* Возможность ответов на вопросы и просмотра вопросов других пользователей
...
* Badoo: оценка собеседника производится в основном по фогографии и по близости местоположения
* OKCupid: приложение недоступно в России
* Sapio: приложение на данный момент не работает
* Splish: приложение на данный момент недоступно
